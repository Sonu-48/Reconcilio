...
import { mostlovedproductdata } from "../../../components/Mostlovedproductdata";
...
function Mostlovedproduct() {
    return (
        <Section>
            <Container>
                <Box align="center" pb={4}>
                    <Typography variant="h3">Most Loved Products</Typography>
                </Box>
                <Box pb={7}>
                ...
                <Grid container spacing={3}>
                    {mostlovedproductdata.map((data, id) => {
                        return (
